...
csv_path = Path("/media/ideabliss/data/creditshield/dataset/synthetic_users/vivekSTUDENT.csv")
loan_type = "personal"
loan_amount = 50000.0
...
out_path = Path("reports/vivekSTUDENT_personal_50000_4page_report.txt")
