...
class RejectionRecoveryScreen extends StatelessWidget {
  ...
  static const _reasons = [
    {'icon': Icons.trending_down, 'label': 'Irregular Income', 'desc': 'Your income appears irregular over the last 3 months.', 'impact': 0.7},
    {'icon': Icons.history, 'label': 'Short Credit History', 'desc': 'Your credit history is less than 12 months old.', 'impact': 0.5},
    {'icon': Icons.account_balance_wallet_outlined, 'label': 'High Debt Ratio', 'desc': 'Your existing EMIs exceed 40% of your monthly income.', 'impact': 0.4},
  ];
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('We couldn\'t approve this application',
                            style: AppTypography.subheading.copyWith(color: AppColors.warning)),
                      ],
                    ),
              ...
              ..._reasons.map((r) => Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(r['icon'] as IconData, size: 16, color: AppColors.warning),
                            const SizedBox(width: 6),
                            Expanded(
                              child: Text(r['label'] as String,
                                  style: AppTypography.body.copyWith(fontWeight: FontWeight.w600)),
                            ),
                            Text('${((r['impact'] as double) * 100).toInt()}% impact',
              ...
              _RecoveryOption(
                ...
                desc: 'Try ₹25,000 (50% of your original request) — higher approval chances.',
                secondary: secondary,
                isDark: isDark,
              ...
              _RecoveryOption(
                ...
                title: 'Try a different lender',
                desc: 'Other lenders may have different eligibility criteria.',
                secondary: secondary,
                isDark: isDark,
                onTap: () => context.push('/lender-offers'),
              ),
              const SizedBox(height: 10),
              _RecoveryOption(
                icon: Icons.calendar_today_outlined,
                title: 'Reapply later',
                desc: 'Suggested reapplication date: 12 April 2025 (after 3 months).',
                secondary: secondary,
                isDark: isDark,
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Reminder set for 12 April 2025')),
                  );
                },
              ),
